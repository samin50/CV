  ...
  return (
    <>
      <div className='bg-white'>
        <div className='flex h-full w-full justify-end py-8'>
          <div className='ml-8'>
            {/* Banner */}
            <div className='bg-[#2B343D] w-full h-44 prose p-4 pt-3 pl-6 mb-6'>
              <h1 className="font-primary font-thin pb-0.5 text-4xl">Shaheen Amin</h1>
              <h2 className='font-primary font-thin text-xl pb-1'>Software/Hardware Engineer</h2>
              <div className='bg-white w-full h-[2px] mb-2'></div>
            ...
            <div className='flex flex-row prose'>
              ...
              <div className="mx-8 w-4/5">
                {/* Education */}
                <div className='text-[#2B343D] font-secondary font-semibold text-3xl pl-5'>EDUCATION</div>
                <div className='w-full bg-[#2B343D] h-[2px]'></div>
                <div className="text-[#2B343D] text-3xl pt-2 pl-5 font-medium">Electronics and Information Engineering/Computer Engineering MEng</div>
                <div className="text-[#2B343D] text-2xl pl-5">Imperial College London</div>
                <div className="text-[#2B343D] text-xl pl-5 font-light"><em>06/2020 - Present</em></div>
                <div className="text-[#2B343D] text-lg pl-5 font-light"><em>Learned skills include, but not limited to:</em></div>
                <div className='flex flex-wrap flex-row text-black pl-5 pt-1'>
                  <ul className="space-y-1 list-square pl-5 text-lg font-light pb-5">
                    <li>Chip Design</li>
                  ...
                  <ul className="space-y-1 list-square pl-72 text-lg font-light">
                ...
                {/* Projects */}
                <div className='text-[#2B343D] font-secondary font-semibold text-3xl pl-5'>PROJECTS</div>
                <div className='w-full bg-[#2B343D] h-[2px] mb-2'></div>
                <div className="text-black pl-5">
                  <Projects title="Portfolio Website" description="Developed a digital circuit simulator and simplifier in C++"/>
                ...
                {/* Experience */}
                <div className='text-[#2B343D] font-secondary font-semibold text-3xl pl-5'>EXPERIENCE</div>
                <div className='w-full bg-[#2B343D] h-[2px]'></div>
                <div className="text-[#2B343D] text-3xl pt-2 pl-5 font-medium">Software Engineer Intern</div>
                <div className="text-[#2B343D] text-3xl pl-5">Jacobs</div>
                <div className="text-[#2B343D] text-xl pl-5 font-light"><em>07/2019 - 08/2019</em></div>
                <ul className='list-square text-lg font-light pl-5 pb-3 text-black'>
                  <li>
